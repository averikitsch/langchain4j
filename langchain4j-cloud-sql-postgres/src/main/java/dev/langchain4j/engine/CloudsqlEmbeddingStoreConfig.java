 ...
 */
public class CloudsqlEmbeddingStoreConfig {
    ...
    private CloudsqlEmbeddingStoreConfig(Builder builder) {
    ...
    public static class Builder {
        ...
        /**
         * Builds an {@link CloudsqlEmbeddingStoreConfig} with the configuration applied to this
         * builder.
         *
         * @return A new {@link CloudsqlEmbeddingStoreConfig} instance
         */
        public CloudsqlEmbeddingStoreConfig build() {
            return new CloudsqlEmbeddingStoreConfig(this);
        }
    }
}
